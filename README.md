...
- 🗂️ **Сворачивание в трей** — скрытие окна в системный трей при закрытии и запуск приложения свёрнутым
- 📝 **Настраиваемый лимит логов** — контроль потребления памяти с записью в файл и автоматической ротацией
