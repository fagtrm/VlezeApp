...
class AppConfig:
    ...
    Attributes:
        vless_dir: Path to the directory containing VLESS configuration files.
    ...
    def __init__(self) -> None:
        self.vless_dir: Path = CONFIG_DIR / "vless"
    ...
    def _ensure_config_dir(self) -> None:
        ...
        self.vless_dir.mkdir(parents=True, exist_ok=True)
        ...
        if CONFIG_FILE.exists():
            try:
                with open(CONFIG_FILE, "r", encoding="utf-8") as fh:
                    ...
                    self.vless_dir = Path(data.get("vless_dir", str(self.vless_dir)))
    ...
    def set_vless_dir(self, path: Path) -> None:
        """Set the VLESS configurations directory and persist the change."""
        self.vless_dir = path
        self._save_config()

    def get_vless_dir(self) -> Path:
        """Return the current VLESS configurations directory."""
        return self.vless_dir

    def is_valid(self) -> bool:
        """Check whether the VLESS directory exists and is a directory."""
        return self.vless_dir.exists() and self.vless_dir.is_dir()
